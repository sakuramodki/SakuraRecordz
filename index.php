        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center">
              <h1 class="title">Sakura Recordz!</h1>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-12 text-center">
              <svg class="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 689.2 706.53">
          ...
          <div class="row">
            <div class="col-lg-12 text-center">
              <a href="#aboutus" class="btn topbtn btn-circle page-scroll">
        ...
        <div class="row text-center">
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary color_y"></i>
              <i class="fa fa-music fa-stack-1x fa-inverse"></i>
            </span>
            <h4 class="service-heading">Music Creation</h4>
            <p class="text-muted">商業・同人を問わずクラブ・ミュージックを中心とした楽曲制作のご依頼を承っています</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary color_m"></i>
              <i class="fa fa-cloud-upload fa-stack-1x fa-inverse"></i>
            </span>
            <h4 class="service-heading">Release</h4>
            <p class="text-muted">Sakura Recordz！が主催するコンピレーション・アルバムをリリースしてます</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary color_y"></i>
